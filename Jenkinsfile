    ...
    stages { 
	    ...
	    stage('Deploy to Docker Host') {
		  steps {
	        ...
	        sh 'docker -H tcp://10.1.1.27:2375 run --rm -dit --name app2 --hostname app2 -p 8007:80 8074764785/pipelinetest:v1
	        sh 'docker -H tcp://10.1.1.27:2375 run --rm -dit --name app3 --hostname app3 -p 8008:80 8074764785/pipelinetest:v1'
		  }
		}
